...
namespace Contoso.Apps.Movies.Data.Logic
{
    public class ShoppingCartActions : IDisposable
    {
        ...
        public ShoppingCartActions(string cartId, IQueryable<Item> items, IQueryable<Category> categories)
        {
            this.items = items;
            this.categories = categories;
            this.ShoppingCartId = cartId;

            shoppingCartItems =  SqlDbHelper.GetCartItems().AsQueryable();
        }
        ...
        public async Task AddToCart(int id)
        {
            ...
            if (cartItem == null)
            {
                Item p = await SqlDbHelper.GetItem(id);
               ...
               int rowInserted = await SqlDbHelper.SaveCartItem(cartItem);
        ...
        public void RemoveItem(string removeCartID, int removeProductID)
        {
            try
            {
                ...
                if (myItem != null)
                {
                    ////SqlDbHelper.DeleteObject(myItem);
        ...
        public void UpdateItem(string updateCartID, int updateProductID, int quantity)
        {
            try
            {
                ...
                if (myItem != null)
                {
                    ...
                    SqlDbHelper.SaveCartItem(myItem);
                }
            }
            catch (Exception exp)
            {
        ...
        public async Task EmptyCart()
        {
            ...
            {
                await SqlDbHelper.DeleteCartItem(cartItem.CartItemId);
